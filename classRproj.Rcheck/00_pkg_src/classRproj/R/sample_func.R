...
#' This is a function to create a sample of the length n for a given pdf
#'
...
#'
#' @return a vector of n sample that have been excepted as being valid according to pdf of the
#' interval (a, b)
#'
